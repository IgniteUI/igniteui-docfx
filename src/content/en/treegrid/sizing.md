...
The [**IgxTreeGrid**]({environment:angularApiUrl}/classes/igxtreegridcomponent.html) automatically adapts its internal spacing based on the [size](display-density.md) setting. You can further customize the padding and margins in grid header and body cells using CSS custom properties for spacing control.
