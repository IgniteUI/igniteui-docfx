...
The sample below demonstrates Tree Grid's **Quick filtering** user experience. API [filter()]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#filter) method is used to apply _contains_ condition on the _ProductName column_ through external _igxInputGroup component_.  



<code-view style="height:600px"
           data-demos-base-url="{environment:demosBaseUrl}"
           iframe-src="{environment:demosBaseUrl}/tree-grid/treegrid-filtering/" alt="Angular Tree Grid Filtering Example">
</code-view>
...
To enable the [Advanced filtering](advanced-filtering.md) however, you need to set the [`allowAdvancedFiltering`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#allowAdvancedFiltering) input properties to `true`.
