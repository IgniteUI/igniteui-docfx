...
<code-view style="height:680px"
           ...
           iframe-src="{environment:demosBaseUrl}/hierarchical-grid/hierarchical-grid-validator-service/" alt="Angular Hierarchical Grid Validation Basic Example">
</code-view>
...
<code-view style="height:640px"
           data-demos-base-url="{environment:demosBaseUrl}"
           iframe-src="{environment:demosBaseUrl}/hierarchical-grid/hierarchical-grid-validator-service-extended/" alt="Angular Hierarchical Grid Custom Validation Example">
</code-view>
...
<code-view style="height:620px"
           data-demos-base-url="{environment:demosBaseUrl}"
           iframe-src="{environment:demosBaseUrl}/hierarchical-grid/hierarchical-grid-cross-field-validation/" alt="Angular Hierarchical Grid Cross-field Validation Example">
</code-view>
