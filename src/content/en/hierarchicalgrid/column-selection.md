...
<code-view style="height:570px"
           ...
           iframe-src="{environment:demosBaseUrl}/hierarchical-grid/column-selection/" alt="Angular Column Selection Example">
</code-view>
...
<code-view style="height:570px"
           data-demos-base-url="{environment:demosBaseUrl}"
           iframe-src="{environment:demosBaseUrl}/hierarchical-grid/column-group-selection/" >
</code-view>
...
<code-view style="height:570px"
           data-demos-base-url="{environment:demosBaseUrl}"
           iframe-src="{environment:demosBaseUrl}/hierarchical-grid/column-selection-styles/" >
</code-view>
