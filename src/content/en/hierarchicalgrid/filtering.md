...
<code-view style="height:610px"
           ...
           iframe-src="{environment:demosBaseUrl}/hierarchical-grid/hierarchical-grid-filtering/" alt="Angular Hierarchical Grid Filtering Example">
</code-view>
...
To enable the [Advanced filtering](advanced-filtering.md) however, you need to set the [`allowAdvancedFiltering`]({environment:angularApiUrl}/classes/igxhierarchicalgridcomponent.html#allowAdvancedFiltering) input properties to `true`.
