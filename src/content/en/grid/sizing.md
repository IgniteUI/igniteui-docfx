...
The [**IgxGrid**]({environment:angularApiUrl}/classes/igxgridcomponent.html) automatically adapts its internal spacing based on the [size](display-density.md) setting. You can further customize the padding and margins in grid header and body cells using CSS custom properties for spacing control.
