...
行追加 UI は、エンド ユーザーに整合性のある編集エクスペリエンスを提供するように設計されているため、行編集 UI と同じ動作をします。詳細については、[Pivot Grid 行編集](row-editing.md)トピックを参照してください。
...
- [Pivot Grid 行追加](row-editing.md#スタイル設定)
