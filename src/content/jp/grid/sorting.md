...
<code-view style="height:550px"
           ...
           iframe-src="{environment:demosBaseUrl}/grid/grid-sorting-sample/" alt="Angular Grid ソートの例">
</code-view>
...
Grid はリモート ソートをサポートします。詳細については、[`Grid リモート データ操作`](remote-data-operations.md)で説明されています。
