...
<code-view style="height:550px"
           ...
           iframe-src="{environment:demosBaseUrl}/grid/grid-sample-2/" alt="Angular Grid 仮想化とパフォーマンスの例">
</code-view>
...
Grid はリモート仮想化をサポートします。詳細については、[`Grid リモート データ操作`](remote-data-operations.md)で説明されています。
