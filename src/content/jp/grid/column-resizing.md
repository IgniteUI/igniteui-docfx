...
<code-view style="height:550px"
           ...
           iframe-src="{environment:demosBaseUrl}/grid/grid-resizing-sample/" alt="Angular Grid 列サイズ変更の例">
</code-view>
...
<code-view style="height:550px"
           data-demos-base-url="{environment:demosBaseUrl}"
           iframe-src="{environment:demosBaseUrl}/grid/grid-columnAutoResizing-sample/" alt="Angular Grid 列のサイズ変更の例">
</code-view>
