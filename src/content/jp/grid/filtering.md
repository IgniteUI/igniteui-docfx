...
<code-view style="height:600px"
           ...
           iframe-src="{environment:demosBaseUrl}/grid/grid-filtering-sample/" alt="Angular Grid フィルタリングの例">
</code-view>
...
ただし、[高度なフィルタリング](advanced-filtering.md)を有効にするには、[`allowAdvancedFiltering`]({environment:angularApiUrl}/classes/igxgridcomponent.html#allowAdvancedFiltering) 入力プロパティを `true` に設定します。
...
Grid はリモート フィルタリングをサポートします。詳細については、[`Grid リモート データ操作`](remote-data-operations.md) で説明されています。
