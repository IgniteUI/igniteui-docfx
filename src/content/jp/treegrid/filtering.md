...
<code-view style="height:600px"
           ...
           iframe-src="{environment:demosBaseUrl}/tree-grid/treegrid-filtering/" alt="Angular Tree Grid フィルタリングの例">
</code-view>
...
ただし、[高度なフィルタリング](advanced-filtering.md)を有効にするには、[`allowAdvancedFiltering`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#allowAdvancedFiltering) 入力プロパティを `true` に設定します。
...
Tree Grid はリモート フィルタリングをサポートします。詳細については、[`Tree Grid リモート データ操作`](remote-data-operations.md) で説明されています。
