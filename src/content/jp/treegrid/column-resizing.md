...
<code-view style="height:550px"
           ...
           iframe-src="{environment:demosBaseUrl}/tree-grid/treegrid-column-resizing/" alt="Angular Tree Grid 列サイズ変更の例">
</code-view>
...
<code-view style="height:550px"
           data-demos-base-url="{environment:demosBaseUrl}"
           iframe-src="{environment:demosBaseUrl}/tree-grid/tree-grid-columnAutoSizing-sample/" alt="Angular Tree Grid 列のサイズ変更の例">
</code-view>
