...
열의 드래그 앤드 드롭 조작을 설정하기 위해 열 이동과 관련된 복수의 이벤트가 제공됩니다. [`columnMovingStart`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#columnMovingStart), [`columnMoving`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#columnMoving) 및 [`columnMovingEnd`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#columnMovingEnd)가 있습니다. 
[`igx-tree-grid`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html)의 [`columnMovingEnd`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#columnMovingEnd) 이벤트를 처리하고 열을 새로운 위치로 드롭할 때 일부 사용자 논리를 구현할 수 있습니다. 예를 들면, Change On Year(%) 열 뒤에 카테고리 드롭을 취소할 수 있습니다.
