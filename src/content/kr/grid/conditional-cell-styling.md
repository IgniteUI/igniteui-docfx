...
### IgxGrid Conditional Cell Styling
The IgxGrid component in Ignite UI for Angular provides **conditional styling of cells** based on custom rules.
...
#### 개요
[`IgxColumnComponent`]({environment:angularApiUrl}/classes/igxcolumncomponent.html) [`cellClasses`]({environment:angularApiUrl}/classes/igxcolumncomponent.html#cellclasses) 입력을 설정하고 사용자 규칙을 정의하여 IgxGrid 셀의 조건부 스타일을 지정할 수 있습니다.
