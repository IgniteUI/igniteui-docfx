...
The resource topic provides implementation of data utility for generating locations of airports, flight paths, and geographic gridlines. You can use these data sources as reference point for creating your own geographic data. Note that this utility depends on [WorldUtil](map_resources_world_util.md) and [WorldLocations](map_resources_world_locations.md) scripts.
