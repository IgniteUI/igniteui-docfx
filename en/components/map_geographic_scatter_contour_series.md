...
The [`IgxGeographicContourLineSeriesComponent`](map_geographic_scatter_contour_series.md) works a lot like the [`IgxGeographicScatterAreaSeriesComponent`](map_geographic_scatter_contour_series.md) except that it represents data as contour lines, colored using a fill scale and the geographic scatter area series, represents data as a surface interpolated using a color scale.

### Data Requirements

Similar to other types of geographic series in the map component, the [`IgxGeographicContourLineSeriesComponent`](map_geographic_scatter_contour_series.md) has the `ItemsSource` property which can be bound to an array of objects. In addition, each item in the items source must have three data columns, two that store geographic location (longitude and latitude coordinates) and one data column that stores a value associated with the geographic location. These data column, are identified by `LongitudeMemberPath`, `LatitudeMemberPath`, and [`valueMemberPath`](map_geographic_scatter_contour_series.md) properties of the geographic series.
The [`IgxGeographicContourLineSeriesComponent`](map_geographic_scatter_contour_series.md) automatically performs built-in data triangulation on items in the ItemsSource if no triangulation is set to the `TrianglesSource` property. However, computing triangulation can be a very time-consuming process, so the runtime performance will be better when specifying a `TriangulationSource` for this property, especially when a large number of data items are present.

### Data Binding

The following table summarizes properties of [`IgxGeographicContourLineSeriesComponent`](map_geographic_scatter_contour_series.md) used for data binding.
...
| [`valueMemberPath`](map_geographic_scatter_contour_series.md) | string        | The name of the property containing a value at Latitude and Longitude coordinates of each data item. This numeric value will be be converted to a color when the [`fillScale`](map_geographic_scatter_contour_series.md) property is set. |
...
Use the [`fillScale`](map_geographic_scatter_contour_series.md) property of the [`IgxGeographicContourLineSeriesComponent`](map_geographic_scatter_contour_series.md) to resolve fill brushes of the contour lines of the geographic series.
...
| Property Name  | Property Type   | Description                                                                                                                                                                                          |
| -------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Brushes`      | BrushCollection | Gets or sets the collection of brushes for filling contours of the [`IgxGeographicContourLineSeriesComponent`](map_geographic_scatter_contour_series.md) |
...
The following code shows how to bind the [`IgxGeographicContourLineSeriesComponent`](map_geographic_scatter_contour_series.md) to triangulation data representing surface temperatures in the world.
