...
The following table summarizes properties of [`IgxGeographicContourLineSeriesComponent`](/components/map_geographic_scatter_contour_series.html) used for data binding.
...
Use the [`fillScale`](/components/map_geographic_scatter_contour_series.html) property of the [`IgxGeographicContourLineSeriesComponent`](/components/map_geographic_scatter_contour_series.html) to resolve fill brushes of the contour lines of the geographic series.
...
| Property Name  | Property Type   | Description                                                                                                                                                                                          |
| -------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Brushes`      | BrushCollection | Gets or sets the collection of brushes for filling contours of the [`IgxGeographicContourLineSeriesComponent`](/components/map_geographic_scatter_contour_series.html) |
...
The following code shows how to bind the [`IgxGeographicContourLineSeriesComponent`](/components/map_geographic_scatter_contour_series.html) to triangulation data representing surface temperatures in the world.
