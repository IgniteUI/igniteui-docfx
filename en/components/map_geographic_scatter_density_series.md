...
Use the map component's [`IgxGeographicHighDensityScatterSeriesComponent`](/components/map_geographic_scatter_density_series.html) to bind and show scatter data ranging from hundreds to millions of data points requiring exceedingly little loading time.
...
| [`longitudeMemberPath`](/components/map_geographic_scatter_density_series.html) | string | Uses the ItemsSource property to determine the location of the longitude values on the assigned items |
| [`latitudeMemberPath`](/components/map_geographic_scatter_density_series.html)   | string | Uses the ItemsSource property to determine the location of the latitude values on the assigned items  |
...
| Property                                                                                                                           | Type   | Description                                                               |
| ---------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------- |
| [`heatMinimum`](/components/map_geographic_scatter_density_series.html)           | Double | Defines the double value representing the minimum end of the color scale  |
| [`heatMaximum`](/components/map_geographic_scatter_density_series.html)           | Double | Defines the double value representing the maximum end of the color scale  |
| [`heatMinimumColor`](/components/map_geographic_scatter_density_series.html) | Color  | Defines the point density color used at the bottom end of the color scale |
| [`heatMaximumColor`](/components/map_geographic_scatter_density_series.html) | Color  | Defines the point density color used at the top end of the color scale    |

### Code Example

The following code demonstrates how set the [`heatMinimumColor`](/components/map_geographic_scatter_density_series.html) and [`heatMaximumColor`](/components/map_geographic_scatter_density_series.html) properties of the [`IgxGeographicHighDensityScatterSeriesComponent`](/components/map_geographic_scatter_density_series.html)
