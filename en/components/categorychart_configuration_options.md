...
The appearance of chart markers is managed through the [`MarkerType`](/angular-apis/typescript/latest/enums/markertype.html), [`markerBrushes`](/angular-apis/typescript/latest/classes/igxdomainchartcomponent.html#markerbrushes), [`markerOutlines`](/angular-apis/typescript/latest/classes/igxdomainchartcomponent.html#markeroutlines) properties of the category chart, as demonstrated in the following code example.
