...
The appearance of chart markers is managed through the [`MarkerType`](/angular-apis/typescript/latest/enums/markertype.html), `MarkerBrushes`, `MarkerOutlines` properties of the category chart, as demonstrated in the following code example.
