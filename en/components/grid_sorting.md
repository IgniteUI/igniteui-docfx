...
#### Remote Sorting
You can activate grid's remote sorting by subscribing to several outputs. More information on how to use it you can find in the `Grid Virtualization and Performance` [documentation](grid_virtualization.md#remote-sortingfiltering-virtualization).
