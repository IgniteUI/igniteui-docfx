...
<div class="sample-container" style="height: 500px">
    <iframe id="map-displaying-geographic-imagery-from-bing-maps-iframe" src='{environment:demosBaseUrl}/maps/map-displaying-geographic-imagery-from-bing-maps' width="100%" height="100%" seamless frameBorder="0" onload="onSampleIframeContentLoaded(this);"></iframe>
</div>
<div>
    <button data-localize="stackblitz" disabled class="stackblitz-btn"   data-iframe-id="map-displaying-geographic-imagery-from-bing-maps-iframe" data-demos-base-url="{environment:demosBaseUrl}">View on StackBlitz
    </button>
</div>
