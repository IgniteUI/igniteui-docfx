...
<div class="sample-container loading" style="height: 500px">
    <iframe id="geo-map-shape-styling-iframe" src='{environment:dvDemosBaseUrl}/maps/geo-map-shape-styling' width="100%" height="100%" seamless frameBorder="0" onload="onXPlatSampleIframeContentLoaded(this);" alt="Angular Shape Styling on Geographic Shape Series Example"></iframe>
</div>
<div>
