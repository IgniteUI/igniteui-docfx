...
Note that in order to synchronize either vertically and/or horizontally, you will need to set the [`isHorizontalZoomEnabled`](datachart_chart_synchronization.md) and/or [`isVerticalZoomEnabled`](datachart_chart_synchronization.md) property to `true`, respectively. A synchronized chart that is dependent on another chart will still zoom regardless of this property setting.
