...
In addition, you must set the [`chartTitle`](/components/datachart_chart_legends.html) property for each series object or the legend will use a default series title.
