...
The following code snippet shows how to display geographic imagery from Esri Maps in [`IgxGeographicMapComponent`](/components/map_displaying_esri_imagery.html) using [`ArcGISOnlineMapImagery`](/components/map_displaying_esri_imagery.html).
