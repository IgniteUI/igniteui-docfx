...
Above series support 12 shapes of markers that you can change using the [`markerType`](/components/datachart_series_markers.html) property.  Also, you can change fill and stroke using [`markerBrush`](/components/datachart_series_markers.html) and [`markerOutline`](/components/datachart_series_markers.html) properties respectively.
