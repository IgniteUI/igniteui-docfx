...
- When the simple combobox is bound to a remote service and there is a predefined selection its input will remain blank until the requested data is not loaded.
