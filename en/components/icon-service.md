...
Starting with version 18.1.x of Ignite UI for Angular, we added a new `setFamily` method that allows us to create a new family of icons in the `iconService` and associate them with a CSS class.
...
| default     | carousel_next  | material      | arrow_forward        | Carousel                                                | Material, Fluent, Bootstrap |
| default     | carousel_prev  | material      | arrow_back           | Carousel                                                | Material, Fluent, Bootstrap |
