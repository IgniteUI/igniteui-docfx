...
<div class="sample-container loading" style="height:600px">
    <iframe id="grid-collapsible-groups-iframe" src='{environment:demosBaseUrl}/grid/grid-collapsible-groups' width="100%" height="100%" seamless="" frameborder="0" onload="onSampleIframeContentLoaded(this);" alt="Angular Grid Collapsible Column Groups Overview Example"></iframe>
</div>
