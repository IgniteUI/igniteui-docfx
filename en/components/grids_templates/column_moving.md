...
> [!NOTE]
> If a header is retemplated and the corresponding column is movable (or groupable), you have to set the **draggable** attribute to **false** on the tempalted elements, so that you can handle any of the events that are applied!
