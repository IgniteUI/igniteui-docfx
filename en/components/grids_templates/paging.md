...
In Ignite UI for Angular Grid, **Paging** is initialized on the root `igx-grid` component and is configurable via the [`paging`]({environment:angularApiUrl}/classes/igxgridcomponent.html#paging) and [`perPage`]({environment:angularApiUrl}/classes/igxgridcomponent.html#perpage) inputs.
...
```html
<igx-grid #grid [data]="data" [paging]="true" [perPage]="10" [paginationTemplate]="pager" height="500px" width="100%" displayDensity="cosy">
</igx-grid>
```
...
```html
<igx-grid #grid [data]="data | async" width="960px" height="550px" [paging]="true" [perPage]="perPage">
