...
_description: The Ignite UI for Angular @@component control features the fastest, touch-responsive data-rich @@component with popular features, including hierarchical and list views.
_keywords: Ignite UI for Angular, UI controls, Angular widgets, web widgets, UI widgets, Angular, Native Angular Components Suite, Native Angular Controls, Native Angular Components Library, Angular Data Grid component, Angular Data Grid control, Angular Grid component, Angular Grid control, Angular High Performance @@component, Filtering, filter
---

### @@component Filtering

The @@component component in Ignite UI for Angular provides extensive filtering API through the Data Container to which the @@component is bound.
...
You can filter any column or a combination of columns through the component API. The component exposes several methods for this task - [`filter`]({environment:angularApiUrl}/classes/@@compdoc.html#filter), [`filterGlobal`]({environment:angularApiUrl}/classes/@@compdoc.html#filterglobal) and [`clearFilter`]({environment:angularApiUrl}/classes/@@compdoc.html#clearfilter).

*   [`filter`]({environment:angularApiUrl}/classes/@@compdoc.html#filter) - filter a single column or a combination of columns.
...
this.@@compRef.filter('ProductName', 'myproduct', IgxStringFilteringOperand.instance().condition("contains"), true);
```
...
> [!NOTE]
> The filtering operation **DOES NOT** change the underlying data source of the @@component.
...
this.@@compRef.filteringExpressionsTree = gridFilteringExpressionsTree;
```

*   [`filterGlobal`]({environment:angularApiUrl}/classes/@@compdoc.html#filterglobal) - clears all existing filters and applies the new filtering condition to all grid's columns.

```typescript
// Filter all cells for a value which contains `myproduct`
this.@@compRef.filteringLogic = FilteringLogic.Or;
this.@@compRef.filterGlobal("myproduct", IgxStringFilteringOperand.instance().condition("contains"), false);
```

*   [`clearFilter`]({environment:angularApiUrl}/classes/@@compdoc.html#clearfilter) - removes any applied filtering from the target column. If called with no arguments it will clear the filtering of all columns.

```typescript
// Remove the filtering state from the ProductName column
this.@@compRef.clearFilter('ProductName');

// Clears the filtering state from all columns
this.@@compRef.clearFilter();
```

#### Initial filtered state

To set the initial filtering state of the @@compRef, set the [`IgxGridComponent`]({environment:angularApiUrl}/classes/@@compdoc.html) [`filteringExpressionsTree`]({environment:angularApiUrl}/classes/@@compdoc.html#filteringexpressionstree) property to an array of [`IFilteringExpressionsTree`]({environment:angularApiUrl}/interfaces/ifilteringexpressionstree.html) for each column to be filtered.
...
The [`filteringLogic`]({environment:angularApiUrl}/classes/@@compdoc.html#filteringlogic) property of the @@compRef controls how filtering multiple columns will resolve in the @@compRef. You can change it at any time through the @@compRef API or through the @@compRef input property.
...
#### Remote Filtering
You can provide @@compRef's remote filtering by subscribing to [`onDataPreLoad`]({environment:angularApiUrl}/classes/@@compdoc.html#ondatapreload) and [`onFilteringDone`]({environment:angularApiUrl}/classes/@@compdoc.html#onfilteringdone) outputs. More information on how to use it you can find in the `Grid Virtualization and Performance` [documentation](grid_virtualization.md#remote-sortingfiltering-virtualization).
...
* IgxGridComponent `filteringExpressions` property is removed. Use [`filteringExpressionsTree`]({environment:angularApiUrl}/classes/@@compdoc.html#filteringexpressionstree) instead.
* `filter_multiple` method is removed. Use [`filter`]({environment:angularApiUrl}/classes/@@compdoc.html#filter) method and [`filteringExpressionsTree`]({environment:angularApiUrl}/classes/@@compdoc.html#filteringexpressionstree) property instead.
* The [`filter`]({environment:angularApiUrl}/classes/@@compdoc.html#filter) method has new signature. It now accepts the following parameters:
...
* [`onFilteringDone`]({environment:angularApiUrl}/classes/@@compdoc.html#onfilteringdone) event now have only one parameter of type [`IFilteringExpressionsTree`]({environment:angularApiUrl}/interfaces/ifilteringexpressionstree.html) which contains the filtering state of the filtered column.
...
* [IgxGridComponent]({environment:angularApiUrl}/classes/@@compdoc.html)
