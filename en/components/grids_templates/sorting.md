...
_description: The Ignite UI for Angular Data @@igComponent control features the fastest, touch-responsive data-rich grid with popular features, including hierarchical and list views.
_keywords: Ignite UI for Angular, UI controls, Angular widgets, web widgets, UI widgets, Angular, Native Angular Components Suite, Native Angular Controls, Native Angular Components Library, Angular Data @@igComponent component, Angular Data @@igComponent control, Angular @@igComponent component, Angular @@igComponent control, Angular High Performance @@igComponent, Sorting, sort
---
...
### API
* [@@igxName]({environment:angularApiUrl}/classes/@@igTypeDoc.html)
* [ISortingExpression]({environment:angularApiUrl}/interfaces/isortingexpression.html)
* [@@igxNameComponent Styles]({environment:sassApiUrl}/index.html#function-@@igSelector-theme)
