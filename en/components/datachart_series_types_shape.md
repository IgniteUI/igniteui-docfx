...
<div class="sample-container" style="height: 300px">
    <iframe id="data-chart-type-shape-series-iframe" src='{environment:demosBaseUrl}/data-chart-type-shape-series' width="100%" height="100%" seamless frameBorder="0" onload="onSampleIframeContentLoaded(this);"></iframe>
</div>
<!-- <div>
