...
This code demonstrates how to create an instance of data chart with `StackedColumnSeries` and bind it to the data source.
...
Note that you can also use above code to create other type of category series by replacing `StackedColumnSeries` with name of series that you want to render. However, the `StackedBarSeries` is an exception from this rule because it requires different types of axes. This code demonstrates how to create an instance of data chart with `StackedBarSeries` and bind it to the data source.
