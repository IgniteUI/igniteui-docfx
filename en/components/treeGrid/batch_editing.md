...
Then you need to define the igxTransactionService as provider for the Tree Grid or on some of its parent components:
...
Then define a Tree Grid with bound data source and [`rowEditable`]({environment:angularApiUrl}/classes/igxtreegridcomponent.html#roweditable) set to true and bind:
...
* [Tree Grid Row Editing](row_editing.md)
