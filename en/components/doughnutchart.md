...
**Enable/disable slice selection** - You can enable (default setting) or disable slice selection in the doughnut chart by setting the [`allowSliceSelection`](doughnutchart.md) property.
...
You can enable or disable the ability to explode slices by setting the [`allowSliceExplosion`](doughnutchart.md) property.
