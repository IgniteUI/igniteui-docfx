...
- `igxGrid`, `igxHierarchicalGrid`, `igxTreeGrid`
    - Parameters in grid templates now have types for their context. This can also cause issues if the app is in strict template mode and uses the wrong type. References to the template that may require conversion:
         ...
         - `IgxGridComponent` - [`GridType`]({environment:angularApiUrl}/interfaces/gridtype.html)
         - `IgxTreeGridComponent` - [`TreeGridType`]({environment:angularApiUrl}/interfaces/treegridtype.html) or [`GridType`]({environment:angularApiUrl}/interfaces/gridtype.html)
         - `IgxHierarchicalGridComponent` - [`HierarchicalGridType`]({environment:angularApiUrl}/interfaces/hierarchicalgridtype.html) or [`GridType`]({environment:angularApiUrl}/interfaces/gridtype.html)
