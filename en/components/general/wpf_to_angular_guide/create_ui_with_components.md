...
If we wanted to style our component, we would come look at our style URL. So let's open up our sample.component.css file and add something to a paragraph. We'll set the color to say red.
```css
p {
    color: red;
}
