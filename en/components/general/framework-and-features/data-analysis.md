...
<input type="button" class="full-screen-btn" onclick='window.open("{environment:lobDemosBaseUrl}/grid-dynamic-chart-data/data-analysis-dock-manager", "_blank")' 
...
<input type="button" class="full-screen-btn" onclick='window.open("{environment:lobDemosBaseUrl}/grid-dynamic-chart-data/data-analysis", "_blank")' 
    value="View in full screen">
</input>
