...
For example, if we have "{environment:host}", it could be replaced by "www.infragistics.com" 
if we have this value for the "host" variable defined in the configuration file.
