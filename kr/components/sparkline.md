...
The Ignite UI for Angular [`IgxSparklineComponent`](sparkline.md) component is a lightweight charting control. It is intended for rendering within a small scale layout such as within a grid cell, but can also be rendered alone.
...
-   [`None`](sparkline.md)
-   [`CubicFit`](sparkline.md)
-   [`CumulativeAverage`](sparkline.md)
-   [`ExponentialAverage`](sparkline.md)
-   [`ExponentialFit`](sparkline.md)
-   [`LinearFit`](sparkline.md)
-   [`LogarithmicFit`](sparkline.md)
-   [`ModifiedAverage`](sparkline.md)
-   [`PowerLawFit`](sparkline.md)
-   [`QuadraticFit`](sparkline.md)
-   [`QuarticFit`](sparkline.md)
-   [`QuinticFit`](sparkline.md)
-   [`SimpleAverage`](sparkline.md)
-   [`WeightedAverage`](sparkline.md)
