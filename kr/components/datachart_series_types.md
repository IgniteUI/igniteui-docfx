...
이 시리즈 외에도 [`IgxDataChart`](/products/ignite-ui-angular/api/docs/typescript/latest/classes/igxdatachart.html) 제어에 [시리즈 주석](datachart_series_annotations.md) 및 [시리즈 강조 표시](datachart_series_highlighting.md)를 추가할 수 있습니다.
