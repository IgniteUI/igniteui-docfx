...
$(function () {
    ...
    (function () {
        ...
        anchors.add(
            'article h2:not(.no-anchor), article h3:not(.no-anchor)'
        );
    })();
    ...
    function highlight() {
        ...
        $('pre code[highlight-lines]').each(function (i, block) {
            ...
            for (var j = 0, range;
                ...
                lines[start - 1] =
                    '<span class="line-highlight">' + lines[start - 1];
                        ...
                        $('#search-results>.sr-items')
                            ...
                            .append(
                                curHits.map(function (hit) {
                                    ...
                                    var itemHref =
                                        relHref + hit.href + '?q=' + query;
                                    var itemTitle = hit.title;
                                    var itemBrief = extractContentBrief(
                                        hit.keywords
                                    );

                                    var itemNode = $('<div>').attr(
                                        'class',
                                        'sr-item'
                                    );
    ...
    function renderNavbar() {
        ...
        function loadNavbar() {
            var navbarPath = $("meta[property='docfx\\:navrel']").attr(
                'content'
            );
            if (!navbarPath) {
                return;
            ...
            var tocPath =
                $("meta[property='docfx\\:tocrel']").attr('content') || '';
            ...
            $.get(navbarPath, function (data) {
                ...
                var currentAbsPath = util.getAbsolutePath(
                    ...
                    .each(function (i, e) {
                        ...
                        if (util.isRelativePath(href)) {
                            ...
                            if (originalHref) {
                                ...
                                if (
                                    util.getDirectory(
                                        util.getAbsolutePath(originalHref)
                                    ) ===
                                    util.getDirectory(
                                        util.getAbsolutePath(tocPath)
                                    )
                                ) {
                                    isActive = true;
                                }
    ...
    function renderSidebar() {
        ...
        function loadToc() {
            ...
            $('#sidetoc').load(tocPath + ' #sidetoggle > div', function () {
                ...
                var currentHref = util.getAbsolutePath(
                    window.location.pathname
                );
                $('#sidetoc')
                    .find('a[href]')
        ...
        if (hierarchy.length > 0) {
            ...
            $('#affix').on('activate.bs.scrollspy', function (e) {
                if (e.target) {
                    ...
                    container.scrollTop(
                        container.scrollTop() + top - height / 2
                    );
                }
            });
            ...
            for (var i = headers.length - 1; i >= 0; i--) {
                ...
                for (var j = length - 1; j >= 0; j--) {
                    ...
                    if (nextLevelSelector) {
                        var selector =
                            '#' + cssEscape(id) + '~' + nextLevelSelector;
...
$(document).ready(function () {
    ...
    $('.anchorjs-link').on('click', function (e) {
        ...
        history.pushState({}, '', window.location.href.split('#')[0] + hashLocation);
