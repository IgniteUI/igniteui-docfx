...
<div>
    <button data-localize="stackblitz" class="stackblitz-btn" data-iframe-id="calendar-sample-iframe" data-demos-base-url="{environment:demosBaseUrl}">StackBlitz で表示</button>
</div>
