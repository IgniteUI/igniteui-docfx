...
_description: Start using angular filter to return data with Ignite UI for Angular Material table similar to the one in excel with convenient usage be theAngular grid filtering
