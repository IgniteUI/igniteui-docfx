...
<div class="sample-container loading" style="height: 530px">
    <iframe id="slide-sample-1-iframe" frameborder="0" seamless width="100%" height="100%" src="{environment:demosBaseUrl}/slider" onload="onSampleIframeContentLoaded(this);"></iframe>
</div>
<div>
