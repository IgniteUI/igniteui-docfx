...
*   [`shouldPanOnMaximumZoom`]({environment:dvApiBaseUrl}/products/ignite-ui-angular/api/docs/typescript/latest/classes/igxseriesviewercomponent.html#shouldpanonmaximumzoom) プロパティを追加しました。
*   新しいカテゴリ軸プロパティ:
