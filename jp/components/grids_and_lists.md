...
<div class="feature feature--hero">
  <div class="feature__details">
    ...
    <a class="cta-btn" href="https://jp.infragistics.com/products/ignite-ui-angular/download">無償版ダウンロード</a>
  </div>
...
<section class="feature__container">
 ...
 <div class="feature">
  ...
  <div class="feature">
    ...
    　　<a href="grid_column_hiding.md" class="feature__more-details">データ グリッドに列ヘッダーを設定</a>
	</div>
    <div class="feature__details">
  ...
  <div class="feature">
    ...
    <div class="feature__details">
      <h3 id="column-text-filter">[列テキスト フィルター](grid_filtering.md)</h3>
  ...
  <div class="feature">
    ...
    <div class="feature__details">
      <h3 id="virtual-column">[仮想化列](grid_virtualization.md)</h3>
  ...
  <div class="feature">
    <div class="feature__image feature__image--left">
      ...
      <a href="grid_multi_column_headers.md" class="feature__more-details">データ グリッドで複数列ヘッダーの設定</a>
    </div>
    <div class="feature__details">
      <h3 id="multi-column-headers">[複数列ヘッダー](grid_multi_column_headers.md)</h3>
  ...
  <div class="feature">
    <div class="feature__image feature__image--left">
      ...
      <a href="grid_toolbar.md" class="feature__more-details">グリッドツールバーの実装方法</a>
    </div>
    <div class="feature__details">
      <h3 id="grid-toolbar">[グリッド ツールバー](grid_toolbar.md)</h3>
  ...
  <div class="feature">
    <div class="feature__image feature__image--right">
      ...
      <a href="grid_search.md" class="feature__more-details">データ グリッドのグローバル検索</a>
    </div>
    <div class="feature__details">
      <h3 id="grid-global-search">[グリッドのグローバル検索](grid_search.md)</h3>
...
<!-- Need 1100 JPG -->
  ...
  <div class="feature">
    <div class="feature__image feature__image--right">
      ...
      <a href="grid_editing.md" class="feature__more-details">Angular Data Grid の編集機能の詳細</a>
    </div>
    <div class="feature__details">
      <h3 id="cell-copying-and-pasting">[セルのコピーおよび貼り付け](grid_editing.md)</h3>
  ...
  <div class="feature">
    <div class="feature__image feature__image--left">
      ...
      <a href="grid.md#data-grid" class="feature__more-details">グリッドのキーボード ナビゲーション機能の拡張</a>
    </div>
    <div class="feature__details">
      <h3 id="keyboard-navigation">[キーボード ナビゲーション](grid.md#data-grid)</h3>
